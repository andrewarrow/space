...
func Seed(c *router.Context) {
	...
	id = makeDevice("Tesla 2017 Red")
	id = makeDevice("Tesla 2019 White")
	id = makeDevice("iBike e-Assist")
	id = makeDevice("Nest")
	id = makeDevice("Ring")
	id = makeDevice("Bathroom Scale")
	id = makeDevice("Bathroom Toothbrush")
	id = makeDevice("Bathroom Mirror")
	id = makeDevice("Coffee")
	id = makeDevice("Jen iPhone")
	id = makeDevice("Jordan iPhone")
	id = makeDevice("Jason iPhone")
	id = makeDevice("Athena iPad")
	id = makeDevice("Austin iPad")
	id = makeDevice("Playstation")
	id = makeDevice("X-Box")
	id = makeDevice("Alexa")
	id = makeDevice("Small Speaker")
	id = makeDevice("2022 MacBook Air")
	id = makeDevice("2020 MacBook Pro")
	id = makeDevice("2021 iMac")
	id = makeDevice("Rouge Bad Guy Device")
}
